...
**特别声明：** 本文档不定时更新、整理当前来自互联网各平台可以免费使用社工库，只作为个人收藏和备用的用途。这些社工库大都提供了付费或免费个人信息开盒、猎魔查人、网购订单与快递数据查询、开房记录查询、微信绑定信息查询、QQ信息查询等功能。下面整理黑盒社工库、繁华社工库、暗精灵社工库等都存在付费功能，但小编并没有对付费功能进行测试，也不对这些社工库负责，只对免费功能进行了简单测试，复杂的没有去测试，也无法测试（毕竟我没钱也没这需求），请各位网友理性看待。
